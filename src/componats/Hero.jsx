...
function Hero() {
  return (
    <>
    <section className='relative h-screen w-full flex justify-center items-start mt-14 flex-wrap gap-5 border-2 border-red-600' >
<div className='shadow-md shadow-gray-100 h-4/5 flex flex-col gap-5 justify-center w-11/12 items-center'>
