...
function Blur({val}) {
  return (
    <div className={`absolute top-0 flex-wrap filter bg-gray-100 flex justify-center backdrop-blur-3xl gap-4 -z-10 container mx-auto w-full h-full ${val}  overflow-hidden  bg-blend-overlay`}>
