...
function Blur({val}) {
  return (
    <div className={`absolute top-0 flex-wrap filter bg-gray-300 flex justify-center  gap-4 transform translate-y-20 -z-10 container mx-auto w-full h-full ${val}  overflow-hidden blur-3xl`}>
